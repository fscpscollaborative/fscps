...
function ReadSettings {
    ...
    $settings = [ordered]@{
        ...
        "deploy"                                 = $false
        "secretsList"                            = @('nugetFeedPasswordSecretName','nugetFeedUserSecretName','lcsUsernameSecretname','lcsPasswordSecretname','azClientsecretSecretname','repoTokenSecretName', 'LAST_COMMIT')
