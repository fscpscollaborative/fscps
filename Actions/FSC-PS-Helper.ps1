...
function GenerateProjectFile {
    ...
    $ProjectFileData = (Get-Content $ProjectFileName).Replace('ModelName', $ModelName.Trim()).Replace('ModelDisplayName', $modelDisplayName).Replace('62C69717-A1B6-43B5-9E86-24806782FEC2'.ToLower(), $ProjectGuid.ToLower())
