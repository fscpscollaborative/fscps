...
function GetLCSSharedAssetsList {
    ...
    $assetsList = Invoke-RestMethod -Method Get -Uri $url -Headers $header | ForEach-Object {[pscustomobject]@{ModifiedDate=$_.ModifiedDate;Name=$_.Name;FullName=$_.FullName;Id=$_.Id}}
    return $assetsList
}    
